...
def image_write(path_A, path_B, path_AB):
    im_A = cv2.imread(path_A, cv2.IMREAD_GRAYSCALE) # python2: cv2.CV_LOAD_IMAGE_COLOR; python3: cv2.IMREAD_COLOR
    im_B = cv2.imread(path_B, cv2.IMREAD_GRAYSCALE) # python2: cv2.CV_LOAD_IMAGE_COLOR; python3: cv2.IMREAD_COLOR
